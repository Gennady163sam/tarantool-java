...
public class TarantoolSpaceMeta {
    ...
    public static final int VSPACE_ID_FILED_NUMBER = 0;
    public static final int VSPACE_NAME_FILED_NUMBER = 2;
    public static final int VSPACE_ENGINE_FILED_NUMBER = 3;
    ...
    public static TarantoolSpaceMeta fromTuple(List<?> spaceTuple, List<List<?>> indexTuples) {
        ...
        return new TarantoolSpaceMeta(
            (Integer) spaceTuple.get(VSPACE_ID_FILED_NUMBER),
            spaceTuple.get(VSPACE_NAME_FILED_NUMBER).toString(),
            spaceTuple.get(VSPACE_ENGINE_FILED_NUMBER).toString(),
